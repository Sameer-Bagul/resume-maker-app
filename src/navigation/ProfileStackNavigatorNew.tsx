...
const ProfileStackNavigator = () => (
    <Stack.Navigator>
        ...
        <Stack.Screen name="Qualifications" component={QualificationsScreen} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="References" component={ReferencesScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AddExperience" component={AddExperienceScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AddProjects" component={AddProjectScreen} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="AddReferences" component={AddReferencesScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AddAwardsScholarships" component={AddAwardsScholarshipsScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AddHobby" component={AddHobbyScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AddQualifications" component={AddQualificationScreen} options={{ headerShown: false }} />
    </Stack.Navigator>
);
