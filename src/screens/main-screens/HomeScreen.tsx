...
type HomeStackParamList = {
  ...
  TemplateSelection: { resumeData: any };
  ResumePreview: { resumeData: any };
};
  ...
  return (
    <LinearGradient style={styles.container} colors={["#4B6CB7", "#182848"]}>
      ...
      <View style={styles.contentContainer}>
        ...
        <TouchableOpacity 
          onPress={() => {
            // For now, navigate to ResumeForm as well, but we can update this later
            navigation.navigate("ResumeForm");
          }}
          style={styles.manualButton}
        >
          <Text style={styles.manualButtonText}>Start Building</Text>
        </TouchableOpacity>
